...
actor CompactBlockProcessor {
    ...
    struct Configuration {
        ...
        init(
            ...
            downloadBatchSize: Int = ZcashSDK.DefaultBatchSize,
    ...
    */
    ...
    private func doRewind(context: AfterSyncHooksManager.RewindContext) async {
        ...
        // FIXME: [#719] this should be done on the rust layer, https://github.com/zcash/PirateLightClientKit/issues/719
    ...
    */
    ...
    func fail(_ error: Error) async {
        // TODO: [#713] specify: failure. https://github.com/zcash/PirateLightClientKit/issues/713
        logger.error("\(error)")
        cancelableTask?.cancel()
        await blockDownloader.stopDownload()
    ...
    // TODO: [#713] encapsulate service errors better, https://github.com/zcash/PirateLightClientKit/issues/713
}
